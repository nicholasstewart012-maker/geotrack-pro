        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    />
                    {/* Overlay Container - Control layout (Desktop: Center, Mobile: Bottom) */}
                    <div className="fixed inset-0 z-50 flex flex-col justify-end md:justify-center items-center pointer-events-none p-0 md:p-6">
                        <motion.div
                            ...
                            className="bg-[#1c1c1e] overflow-hidden pointer-events-auto shadow-2xl flex flex-col w-full h-[85vh] rounded-t-[32px] md:rounded-[32px] md:max-w-md md:h-auto md:max-h-[85vh] md:w-full"
                        >
                            {/* Header */}
